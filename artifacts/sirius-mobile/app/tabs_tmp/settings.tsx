...
import { generatePortrait, getApiBase, PROFILE_KEY, USER_ID_KEY } from "@/lib/api";
...
export default function SettingsScreen() {
  ...
  const { profile, updateLocalProfile, refreshProfile, userId, signOut } = useApp();
  ...
  const handleSignOut = () => {
    Alert.alert(
      "Sign Out",
      "This will clear your local session. Your account and subscription will be preserved.",
      [
  ...
  const handleDeleteAccount = () => {
    Alert.alert(
      "Delete Account",
      "To permanently delete your account and all associated data, please contact our support team. We will process your request within 48 hours.",
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Contact Support",
          onPress: () => Linking.openURL("mailto:support@sirius-ai.live?subject=Delete%20My%20Account%20Request"),
        },
      ]
    );
  };
  ...
  const PRICES = { plus: "£19.99", pro: "£19.99" };
    ...
    >
        ...
        <View style={styles.upgradeSection}>
          ...
          >
            <View style={styles.plusCardInner}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={styles.plusCardTitle}>Go Premium — £19.99/month</Text>
                <Text style={styles.plusCardDesc}>75 messages/day · Dream Lab · Star Lab · Full Sirius</Text>
              </View>
      ...
      <View style={styles.card}>
        ...
        <SettingRow
          ...
          onPress={() => Linking.openURL("mailto:support@sirius-ai.live")}
        />
        <SettingRow
          icon="log-out"
          label="Sign Out"
      ...
      <View style={styles.card}>
        ...
        <View style={styles.disclosureRow}>
          ...
          <Text style={styles.disclosureText}>
            Sirius is an AI assistant. Responses are generated by AI and may not always be accurate.
          </Text>
        </View>
      </View>
          ...
          {payStep === "details" ? (
            <>
              ...
              {[
                ...
                ["Reference", `SIRIUS-${(userId ?? "GUEST").substring(0, 8).toUpperCase()}-PREMIUM`],
              ].map(([label, value]) => (
