  ...
  return (
    ...
    >
      <div className="text-center relative">
        ...
        <h1 className="text-6xl md:text-7xl font-light leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
          <motion.span
        ...
        <motion.div
          className="mt-8 text-4xl text-white tracking-wider text-glow"
