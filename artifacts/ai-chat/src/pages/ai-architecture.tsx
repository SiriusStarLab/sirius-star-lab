      ...
      <div className="relative isolate overflow-hidden rounded-2xl bg-gradient-to-br from-amber-500 via-orange-600 to-red-600 p-8 shadow-2xl">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h2 className="text-2xl font-black text-white tracking-tight">AI Architecture R&amp;D</h2>
              <p className="text-white/80 text-sm">Research &amp; Development Intelligence — Sirius Star Lab</p>
            </div>
          </div>
          <p className="text-white/70 text-sm max-w-3xl">Understanding the AI systems that power modern app development — from custom LLM training to autonomous agent workflows. Your reference guide for how AI builds software.</p>
        </div>
      </div>
        ...
        <Card className="border-2 border-amber-200 shadow-xl overflow-hidden">
          ...
          <CardContent className="p-5 space-y-4">
            ...
            <div className="rounded-lg bg-gradient-to-r from-orange-50 to-red-50 p-4 border border-orange-200">
              ...
              <p className="text-xs text-slate-500">Full model trained in under a week to meet launch deadline — described as their best career accomplishment.</p>
            </div>
          </CardContent>
        </Card>
