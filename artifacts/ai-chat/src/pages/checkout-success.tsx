...
export function CheckoutSuccessPage() {
  ...
  useEffect(() => {
    // Read the tier from URL params (?tier=plus or ?tier=pro)
    ...
    <div
      ...
      <div className="relative z-10 text-center max-w-md mx-auto">
        <div className="flex items-center justify-center mb-8">
          {!activated ? (
            <div className="w-20 h-20 rounded-full flex items-center justify-center"
              style={{ background: "hsl(193 100% 52% / 0.08)", border: "1px solid hsl(193 100% 52% / 0.2)" }}>
              <Loader2 size={36} className="animate-spin" style={{ color: "hsl(193 100% 52%)" }} />
            </div>
          ) : (
            <div className="w-20 h-20 rounded-full flex items-center justify-center"
              style={{
        ...
        <p className="text-muted-foreground/80 text-base mb-2">
          {activated ? "Your subscription is now active." : "Setting up your account..."}
        </p>
        ...
        {activated && (
          <>
            <div className="rounded-xl p-5 mb-8 text-left"
              style={{ background: "hsl(224 24% 8%)", border: "1px solid hsl(193 100% 52% / 0.15)" }}>
            ...
            <Link href="/"
              className="w-full py-3.5 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold mb-4 transition-all duration-200"
              style={{ background: "hsl(193 100% 52%)", color: "hsl(224 28% 5%)" }}>
              <ArrowLeft size={15} />
              Back to Sirius
            </Link>
