      ...
      <div className="p-4 lg:p-6 flex items-center justify-between">
        ...
        >
          <img 
            ...
            onError={(e) => {
              // Fallback to div if image fails to load during dev
              e.currentTarget.style.display = 'none';
              e.currentTarget.parentElement?.insertAdjacentHTML('afterbegin', '<div class="w-8 h-8 rounded-lg bg-primary flex items-center justify-center"><div class="w-4 h-4 bg-primary-foreground rounded-sm"></div></div>');
            }}
          />
          Nexus AI
        </Link>
              ...
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3 overflow-hidden">
                    <MessageSquare size={16} className={cn("shrink-0", isActive ? "text-primary" : "text-sidebar-foreground/50")} />
