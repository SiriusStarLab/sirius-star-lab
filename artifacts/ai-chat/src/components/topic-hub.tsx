...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    label: "E-Commerce",
    tag: "COMMERCE",
    prompt: "I want to build or grow an e-commerce business. Help me think through product selection, store optimisation, listing strategy, pricing, platform choice (Shopify, Amazon, Etsy, TikTok Shop), and what actually drives sales today. Be specific and practical — I want real tactics that work right now.",
    accent: "25 90% 58%",
    voiceScript: "Every product on earth was once just an idea someone had. Then someone decided to sell it. And the difference between products that disappear and products that dominate is almost never the product itself — it's strategy. It's understanding where your customer is, what language moves them, and how to position your offer so it feels like the obvious answer to a problem they already have. Today, we look at your product, your market, and your opportunity — not with hope, but with precision. Let's build something real.",
  },
  {
    emoji: "📣",
    label: "Digital Marketing",
    tag: "MARKETING",
    prompt: "I want to get better at digital marketing — ads, content, email, SEO, social media, conversion. Tell me what's actually working right now across channels. I want strategies I can act on immediately, not theory.",
    accent: "200 90% 55%",
    voiceScript: "Attention is the new currency — and it's never been more expensive to buy, or more rewarding to earn. The brands winning right now are not the ones with the biggest budgets. They are the ones who understand how people move through digital spaces — how they scroll, what they stop for, what makes them click, what makes them trust. They have figured out the difference between being seen and being remembered. Today, we build that understanding for your business. We look at your funnel, your content, your channels, and we find exactly where the growth is hiding.",
  },
  {
    emoji: "🎯",
    label: "Brand & Growth",
    tag: "BRAND STRATEGY",
    prompt: "I want to think about my brand and growth strategy. Who am I really talking to? What do I stand for? How do I build something people feel loyal to, not just buy from? And how do I grow — organically, virally, strategically — without just throwing money at it?",
    accent: "330 75% 62%",
    voiceScript: "A brand is not a logo. It is not a colour palette. A brand is a feeling someone has when they think of you — and that feeling is the most valuable thing you can build. The companies people love — really love — have figured out how to stand for something specific, speak to someone specific, and deliver something that feels irreplaceable. Growth follows. Loyalty follows. Pricing power follows. Today, we build that clarity for your brand — because when you know exactly what you stand for and who you serve, every marketing decision becomes obvious.",
  },
  {
    emoji: "💬",
    label: "Just Talk",
