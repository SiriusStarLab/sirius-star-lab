...
export function Scene4() {
  ...
  return (
    ...
    >
      ...
      <motion.p 
        className="text-2xl text-center text-white font-light leading-relaxed max-w-sm" style={{ fontFamily: 'var(--font-display)' }}
      ...
      <motion.p 
        className="text-4xl text-center text-purple-200 mt-4 italic text-glow" style={{ fontFamily: 'var(--font-display)' }}
        initial={{ opacity: 0, y: 20 }}
